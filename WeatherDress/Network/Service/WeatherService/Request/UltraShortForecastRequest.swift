//
//  UltrShortForecastRequest.swift
//  WeatherDress
//
...
struct UltraShortForecastRequest: ShortForecastRequestable {
    typealias Response = UltraShortForecastWeatherResponse

    let path: String = "getUltraSrtFcst"
